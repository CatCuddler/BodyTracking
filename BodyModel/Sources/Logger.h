...
public:
	...
	void saveEvaluationData(float lastTime, int nodeID, int pose, int difficulty, int trials, bool head, bool hip, bool left_arm, bool right_arm, bool left_leg, bool right_leg);
