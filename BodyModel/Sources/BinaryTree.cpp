...
BinaryTree::BinaryTree() {
	...
	const char* const text13 = "Sprich mit deinem Assistenten: Ich hab mich für dich ein bisschen Umgehört... Gerüchten zufolge hatten der Magier und sein Assistent einen großen Streit über die neuen Zirkusplakate. Eventuell solltest du mal mit des Assistenten Reden.";
	const char* const text14 = "Sprich mit Clown 1: Der Assistenz des Magiers war's! Ich hab es nicht gesehen aber ich weiß es! Nenn es clownische Intuition!";
	const char* const text15 = "Sprich mit Clown2: Seltsame Dinge passieren hier. Seltsam seltsam, so seltsam wie Clowns. Oder der komische Typ, der hier herumschleicht.";
	const char* const text16 = "Sprich mit dem strangen Dude: Ich habe mit einem Clown geredet... frag mich nicht mit welchem... aber er weiß wer es war!";
	const char* const text17 = "Sprich mit dem Dompteur: Ich wette wer auch immer dein Seil durchgeschnitten hat, hat meinem Baby auch das Spielzeug geklaut... hat du schon mit dem Magier geredet?";
