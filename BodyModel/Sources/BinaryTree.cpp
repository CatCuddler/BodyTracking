...
BinaryTree::BinaryTree() {
	...
	const char* const text3 = "(3) Sprich mit Clown 1: Hast du Schnuffels Spielzeug gesehen? Wir können es nirgends finden... Hast du diesen komischen Typen gesehen der hier vor dem Zelt rumlungert? Ich wette der hat es geklaut!";
	Node* node3 = new Node(Clown1, text3);
	
	const char* const text4 = "(4) Sprich mit dem strangen Dude: Ja, ich habe deinen Unfall gesehen. Schrecklich! Aber ich habe damit nichts zu tun! Ich bin wegen des Löwens hier! Er ist so niedlich! Und flauschig! Und wunderschön! So eine große Miezekatze! Ich habe aber gestern einen der Clowns hier rumschleichen sehen... es geht mich ja nichts an aber der sah mir schon verdächtig aus...";
	Node* node4 = new Node(Dude, text4);
	
	const char* const text5 = "(5) Sprich mit dem Dompteur: Ich hab dir doch gesagt ich weiß von nichts! Sprich mit dem Magier. Ich hab mir sagen lassen er war ziemlich wütend darüber, nicht mehr die Nummer 1 zu sein...";
	Node* node5 = new Node(Dompteur, text5);
	
	const char* const text6 = "(6) Sprich mit dem Magier: Ich? Neidisch auf deinen Erfolg? Nein, niemals! Ich werde alt, meine Zeit hier geht zu Ende. Ich freue mich zu sehen, dass die nächste Generation dem Zirkus gut tut! Wo wir grade reden: Weißt du was mit den Clowns los ist? Die verhalten sich alle seltsam...";
	Node* node6 = new Node(Magier, text6);
	
	const char* const text7 = "(7) Sprich mit Clown 4: Natürlich verhalten wir uns seltsam. Wir sind Clowns, das liegt in unserer Natur! Wäre ein nicht seltsamer Clown nicht viel seltsamer als ein seltsamer Clown? Bestimmt... aber wäre er auch Seltsamer als 2 seltsame Clown? Sprich mal mit meinem Kollegen der kennt die Antwort.";
	Node* node7 = new Node(Clown4, text7);
	
	const char* const text8 = "(8) Sprich mit Clown 2: Zwei seltsame Clowns sind seltsamer als ein nicht seltsamer Clown! Das ist doch logisch... Clowns setzen auf Masse statt Klasse... Wo wir gerade bei seltsam sind, hast du diesen Typen hier rumschleichen sehen?";
	Node* node8 = new Node(Zirkusdirektor, text8);
	
	const char* const text9 = "(9) Sprich mit dem strangen Dude: Ich durfte die Miezekatze streicheln! Er ist so niedlich! Aber er hat sein Spielzeug verloren... armes Tierchen... einer der Clowns wollte suchen helfen.";
	Node* node9 = new Node(Zirkusdirektor, text9);
	
	const char* const text10 = "(10) Sprich mit Clown 3: Ich habe gesehen wer´s war! Zumindest glaube ich das... nein... ich bin mir sicher! Es war der Clown! Ich hab ihn an seinem Gang erkannt! Oder war es doch der Assistent des Magiers? Ach, die beiden sehen sich viel zu ähnlich...";
	Node* node10 = new Node(Clown3, text10);
	
	const char* const text11 = "(11) Sprich mit dem Assistenten des Magiers: Du glaubst also nicht dass dein Unfall ein Unfall war? Ha! Dann seid ihr Artisten doch nicht so dumm wie ich dachte! Geschieht dir trotzdem Recht! Einfach meinem Boss die Show stehlen! Jeder kann turnen wenn er nur ein bisschen übt aber Magie? Das ist noch eine echte Kunstform! Du hast es verdient und ich würde es wieder tun!";
	Node* node11 = new Node(AssistentMagier, text11);
	
	const char* const text12 = "(12) Sprich mit Clown 1: Hast du mal gesehen wie der Assistent des Magiers dich anstarrt? Der ist neidisch sag ich dir... Das ist kein hübscher Charakterzug von ihm.“";
	...
	const char* const text16 = "(16) Sprich mit deinem Assistenten: Ich hab mich für dich ein bisschen Umgehört... Gerüchten zufolge hatten der Magier und sein Assistent einen großen Streit über die neuen Zirkusplakate. Eventuell solltest du mal mit des Assistenten Reden.";
	Node* node16 = new Node(Assistent, text16);
	
	Node* node17 = new Node(AssistentMagier, text11);
	
	const char* const text18 = "(18) Sprich mit Clown 1: Der Assistenz des Magiers war's! Ich hab es nicht gesehen aber ich weiß es! Nenn es clownische Intuition!";
	...
	const char* const text25 = "(25) Sprich mit Clown2: Seltsame Dinge passieren hier. Seltsam seltsam, so seltsam wie Clowns. Oder der komische Typ, der hier herumschleicht.";
	Node* node25 = new Node(Clown2, text25);
	
	const char* const text26 = "(x) Sprich mit dem strangen Dude: Ich habe mit einem Clown geredet... frag mich nicht mit welchem... aber er weiß wer es war!“";
	...
	const char* const text31 = "(31) Sprich mit dem Dompteur: Ich wette wer auch immer dein Seil durchgeschnitten hat, hat meinem Baby auch das Spielzeug geklaut... hat du schon mit dem Magier geredet?";
	...
	const char* const text36 = "(36) Sprich mit dem Zirkusdirektor: Nicht zu fassen, dass so etwas in meinem Zirkus passiert! Ich glaube nicht daran, dass es kein Unfall war. Niemand aus meinem Zirkus würde so etwas tun! Am wenigsten der Magier, auch wenn manche behaupten er beneide dich um deinen Erfolg... Geh doch zu ihm und überzeug dich selbst davon";
	...
	const char* const text60 = "(60) Sprich mit dem Magier: Eventuell kann dir dein Assistent ja bei der Suche weiter helfen. Wozu sind Assistenten denn sonst da?";
