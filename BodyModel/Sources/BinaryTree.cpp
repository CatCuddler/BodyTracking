...
BinaryTree::BinaryTree() {
	...
	createNewNode(42, Magier, text17);
	createNewNode(47, Dude, text14);
	createNewNode(48, Assistent, text1);
	createNewNode(49, Clown4, text12);
	createNewNode(50, Assistent, text1);
	createNewNode(51, Clown3, text10);
	createNewNode(53, AssistentMagier, text18);
	createNewNode(55, AssistentMagier, text18);
	createNewNode(63, Magier, text16);
	createNewNode(64, Dude, text15);
	createNewNode(65, Dude, text15);
	createNewNode(66, Dompteur, text4);
	createNewNode(79, Dude, text14);
	createNewNode(81, AssistentMagier, text18);
	createNewNode(83, AssistentMagier, text18);
	createNewNode(85, AssistentMagier, text18);
	createNewNode(95, Clown3, text10);
	createNewNode(96, Clown1, text7);
	createNewNode(97, AssistentMagier, text18);
	createNewNode(99, Clown2, text9);
	createNewNode(100, Assistent, text1);
	createNewNode(101, AssistentMagier, text18);
	createNewNode(103, AssistentMagier, text18);
	...
	createNewNode(191, AssistentMagier, text18);
	createNewNode(193, AssistentMagier, text18);
	createNewNode(199, Dude, text14);
	createNewNode(200, Clown1, text7);
	createNewNode(201, AssistentMagier, text18);
	createNewNode(255, Clown2, text8);
	createNewNode(256, Assistent, text1);
	createNewNode(257, AssistentMagier, text18);
	createNewNode(259, AssistentMagier, text18);
	createNewNode(261, AssistentMagier, text18);
	createNewNode(263, AssistentMagier, text18);
	createNewNode(265, AssistentMagier, text18);
	createNewNode(267, AssistentMagier, text18);
	createNewNode(269, AssistentMagier, text18);
	createNewNode(319, AssistentMagier, text18);
	createNewNode(321, Clown4, text12);
	createNewNode(322, Clown1, text7);
	createNewNode(399, Clown3, text10);
	createNewNode(401, AssistentMagier, text18);
	createNewNode(511, Dude, text14);
	createNewNode(512, Clown1, text6);
	createNewNode(513, AssistentMagier, text18);
	createNewNode(643, Clown2, text9);
	createNewNode(645, AssistentMagier, text18);
	createNewNode(644, Assistent, text1);
	createNewNode(799, AssistentMagier, text18);
	createNewNode(1023, Clown3, text10);
	createNewNode(1024, Clown1, text6);
	createNewNode(1025, AssistentMagier, text18);
	createNewNode(1287, Dude, text15);
	createNewNode(1288, Clown1, text7);
	createNewNode(1289, AssistentMagier, text18);
	createNewNode(2047, AssistentMagier, text18);
	createNewNode(2049, AssistentMagier, text18);
	createNewNode(2575, Clown3, text10);
	createNewNode(2577, AssistentMagier, text18);
	createNewNode(5151, AssistentMagier, text18);
