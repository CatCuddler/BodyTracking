...
BinaryTree::BinaryTree() {
	...
	Sound* intro = new Sound("sound/story/intro.wav");
	Sound* outro = new Sound("sound/story/outro.wav");
	Sound* assistent_1 = new Sound("sound/story/assistent_1.wav");
	Sound* assistent_2 = new Sound("sound/story/assistent_2.wav");
	Sound* dompteur_1 = new Sound("sound/story/dompteur_1.wav");
	Sound* dompteur_2 = new Sound("sound/story/dompteur_2.wav");
	Sound* dompteur_3 = new Sound("sound/story/dompteur_3.wav");;
	Sound* clown1_1 = new Sound("sound/story/clown1_1.wav");
	Sound* clown1_2 = new Sound("sound/story/clown1_2.wav");
	Sound* clown1_3 = new Sound("sound/story/clown1_3.wav");
	Sound* clown2_1 = new Sound("sound/story/clown2_1.wav");
	Sound* clown2_2 = new Sound("sound/story/clown2_2.wav");
	Sound* clown3_1 = new Sound("sound/story/clown3_1.wav");
	Sound* clown4_1 = new Sound("sound/story/clown4_1.wav");
	Sound* clown4_2 = new Sound("sound/story/clown4_2.wav");
	Sound* dude_1 = new Sound("sound/story/dude_1.wav");
	Sound* dude_2 = new Sound("sound/story/dude_2.wav");
	Sound* dude_3 = new Sound("sound/story/dude_3.wav");
	Sound* magier = new Sound("sound/story/magier.wav");
	Sound* assistent_magier = new Sound("sound/story/assistent_magier.wav");
	Sound* zirkusdirektor = new Sound("sound/story/zirkusdirektor.wav");
