...
public:
	...
	void render(Kore::Graphics4::TextureUnit tex, Kore::Graphics4::ConstantLocation mLocation, Kore::Graphics4::ConstantLocation nLocation, Kore::Graphics4::ConstantLocation cLocation);
